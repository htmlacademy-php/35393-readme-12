...
$posts = [
    [
        'ttl' => 'Цитата',
        'type' => 'post-quote',
        'anons' => 'Мы в жизни любим только раз, а после ищем лишь похожих',
        'username' => 'Лариса',
    ...
    [
        'ttl' => 'Игра престолов',
        'type' => 'post-text',
        'anons' => 'Не могу дождаться начала финального сезона своего любимого сериала!',
        'username' => 'Владик',
        'avatar_url' => 'userpic.jpg'
    ],
    [
        'ttl' => 'Наконец, обработал фотки!',
        'type' => 'post-photo',
        'anons' => 'rock-medium.jpg',
        'username' => 'Виктор',
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                ...
                                <img class="post__author-avatar" src="img/<?=$val['avatar_url'];?>" alt="Аватар пользователя">
                            </div>
